...
const { LitElement: LitElement$1,html: html$1,css: css$1 } = litElement;class MyCounter extends LitElement$1 {
  constructor() {
    super();
    this.count = 0;
  }
    ...
    return html$1`
      <style>
        ${this.disabled ? `* {
          ...
          button {
          background-color: ${this.variant === "secondary" ? "orange" : "seagreen"};
        }
      </style>
